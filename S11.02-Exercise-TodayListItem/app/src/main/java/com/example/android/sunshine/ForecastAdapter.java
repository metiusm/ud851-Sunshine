...
//  COMPETED (1) Add a layout called list_item_forecast_today
//  COMPETED (2) Using ConstraintLayout, implement the today list item layout

//  COMPETED (4) Create a resources file called bools.xml within the res/values-port directory
//  COMPETED (5) Within bools.xml in the portrait specific directory, add a bool called use_today_layout and set it to false

//  COMPETED (6) Declare constant IDs for the ViewType for today and for a future day
    public static final int VIEW_TYPE_ID_TODAY = 0;
    public static final int VIEW_TYPE_ID_FUTURE = 1;
...
//      COMPLETED (13) If the view type of the layout is future day, use future day layout
        if(viewType == VIEW_TYPE_ID_FUTURE)
        {
            view = LayoutInflater
                    .from(mContext)
...
//      COMPLETED (12) If the view type of the layout is today, use today layout
        else if(viewType == VIEW_TYPE_ID_TODAY)
        {
            view = LayoutInflater
                    .from(mContext)
...
//  COMPLETED (9) Override getItemViewType
    ...
    public int getItemViewType(int position) {
        ...
        if(mUseTodayLayout && position == 0) return VIEW_TYPE_ID_TODAY;

        //      COMPLETED (11) Otherwise, return the ID for future day viewType
        return VIEW_TYPE_ID_FUTURE;
    }
