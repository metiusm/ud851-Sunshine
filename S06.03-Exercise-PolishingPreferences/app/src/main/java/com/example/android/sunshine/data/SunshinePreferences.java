...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String preferredWeatherLocation = preferences.getString(context.getString(R.string.pref_location_key), context.getString(R.string.pref_location_default));
    ...
    public static boolean isMetric(Context context) {
        ...
        String preferredMetric = preferences.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        if(preferredMetric == context.getString(R.string.pref_units_metric))
            return true;
